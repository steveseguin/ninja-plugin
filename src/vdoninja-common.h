...
const std::vector<std::string> DEFAULT_STUN_SERVERS = {"stun:stun.l.google.com:19302",
...
using OnOfferCallback = std::function<void(const std::string &uuid, const std::string &sdp,
                                           const std::string &session)>;
using OnAnswerCallback = std::function<void(const std::string &uuid, const std::string &sdp,
                                            const std::string &session)>;
using OnIceCandidateCallback =
    std::function<void(const std::string &uuid, const std::string &candidate,
...
using OnStreamAddedCallback =
    std::function<void(const std::string &streamId, const std::string &uuid)>;
using OnStreamRemovedCallback =
    std::function<void(const std::string &streamId, const std::string &uuid)>;
using OnDataCallback = std::function<void(const std::string &uuid, const std::string &data)>;

// Video codec preferences
enum class VideoCodec { H264, VP8, VP9, AV1 };
